...
class BevyInspectorExtension {
    ...
    constructor(context: vscode.ExtensionContext) {
        ...
        context.subscriptions.push(
            ...
            vscode.commands.registerCommand('bevyInspector.copyComponentName', (arg: any) =>
                this.copyComponentName(arg),
            ),
    ...
    private async goToDefinition(component: Component) {
        ...
        if (location && location.uri) {
            ...
            await vscode.window.showInformationMessage(
                `No symbol found in workspace for component "${component.name}".`,
            );
        }
    }
}
