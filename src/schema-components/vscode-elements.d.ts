...
import type { VscTreeActionEvent, VscTreeSelectEvent } from '@vscode-elements/elements/dist/vscode-tree/vscode-tree';

type ElementProps<I> = Partial<Omit<I, keyof HTMLElement>>;
type CustomEventHandler<E> = (e: E) => void;

type WebComponentProps<I extends HTMLElement> = React.DetailedHTMLProps<React.HTMLAttributes<I>, I> & ElementProps<I>;
