...
export class V0_18BrpAdapter implements BrpAdapter {
  private remoteService: brp18.BevyRemoteService;

  public constructor(remoteService: brp18.BevyRemoteService) {
    this.remoteService = remoteService;
  }

  public readonly bevyVersion = '0.18';
  ...
  public parentIdFromParentComponent(value: unknown): brplatest.EntityId | undefined {
    type ChildOfComponent = brp18.EntityId;
  ...
  public async getComponents(params: brplatest.GetParams): Promise<brplatest.GetResult> {
    if (params.strict === true) {
      return await this.remoteService.getComponents(params satisfies brp18.GetStrictParams);
    } else {
      return await this.remoteService.getComponents(params satisfies brp18.GetLenientParams);
    }
  }
  ...
  public async listComponents(params?: brp18.ListParams): Promise<brplatest.ListResult> {
  ...
  public async registrySchema(params?: brp18.RegistrySchemaParams): Promise<brplatest.RegistrySchemaResult> {
