import type { BevyRemoteService, GetParams, InsertParams, MutateComponentParams } from '../../brp/brp-0.18';
...
export class V0_18ComponentRepository implements ComponentRepository {
